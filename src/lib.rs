...
#[derive(Debug)]
pub struct SaikouHubProcessor {
    verbose: bool,
    processed_count: usize,
}

impl SaikouHubProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting SaikouHub processing");
    
    let mut processor = SaikouHubProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = SaikouHubProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = SaikouHubProcessor::new(false);
